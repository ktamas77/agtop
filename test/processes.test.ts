...
import { exeBase, listAllProcesses } from '../src/processes.ts';

Deno.test('exeBase returns the executable basename', () => {
...
Deno.test('listAllProcesses returns well-formed records', () => {
